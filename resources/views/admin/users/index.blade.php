                    ...
                    <tr class="hover:bg-slate-50/50 dark:hover:bg-white/5 transition-colors group">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                @if($user->id !== 1)
                                <form action="{{ route('users.destroy', $user->id) }}" method="POST" data-confirm="Hapus user ini?" data-confirm-title="Hapus User">
                                    @csrf @method('DELETE')
                        ...
                        <div class="md:col-span-2 space-y-1.5">
                            ...
                            <div class="relative group">
                                <input :type="showPassword ? 'text' : 'password'" 
                                    name="password" 
                                    class="w-full px-5 pr-12 py-3.5 bg-slate-50 dark:bg-slate-800 border-2 border-transparent focus:border-brand-primary rounded-2xl text-sm text-slate-800 dark:text-white font-bold outline-none transition-all shadow-inner placeholder:text-slate-300 dark:placeholder:text-slate-600" 
                                    placeholder="••••••••">

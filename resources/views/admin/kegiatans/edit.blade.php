        ...
        <div class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-white/5 shadow-sm overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="date" name="tanggal_mulai" value="{{ old('tanggal_mulai',$kegiatan->tanggal_mulai->format('Y-m-d')) }}" @input="syncTahunAnggaran($event.target.value)" required class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-800 border-2 border-transparent focus:border-brand-primary rounded-2xl text-sm text-slate-800 dark:text-white font-bold outline-none transition-all">
                </div>
                <div class="space-y-1.5">
